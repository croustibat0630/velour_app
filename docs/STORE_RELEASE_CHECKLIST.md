...
Implémentation : `lib/services/velour_analytics.dart` (`velour_menu_view`, `velour_prep_open`, `velour_run_start`, `velour_run_end`, funnel boutique `velour_shop_view` / `velour_shop_vault_buy_*` + `logAppOpen`).
