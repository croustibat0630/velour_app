...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  ({Rect playZoneRect, Rect luxSafeRect, double boardSpawnMinY, double itemSize, double slotSize, double gridGap, List<Offset> slotTopLefts})?
      _lastLayout;
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final Set<String> boardIds =
                      gameState.boardItems.map((e) => e.id).toSet();
