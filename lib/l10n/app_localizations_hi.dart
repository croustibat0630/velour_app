...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get prepGuidedTutorialGoalBody =>
      'तीन निर्देशित मैच: आकार → रंग → परफेक्ट। सीखने के लिए टाइमर रुका रहता है।';

  @override
  String get prepGuidedTutorialStrategyTitle => 'कैसे खेलें';

  @override
  String get prepGuidedTutorialStrategyBody =>
      'धड़कते रत्नों पर टैप करें। परफेक्ट (समान आकार और रंग) मुख्य पल है — +500 देखें।';
