...
- **CI compile store (manuel)** : workflow GitHub *Store release compile check* (AAB release + `VELOUR_PRIVACY_POLICY_URL`, voir `.github/workflows/store_release_compile.yml`).
