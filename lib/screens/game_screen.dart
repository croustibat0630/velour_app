        ...
        body: SafeArea(
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final double slotBarHeight = (100 * uiScale).clamp(88.0, 130.0);
              final double slotSize = (GameState.baseSlotSize * uiScale).clamp(
                38.0,
                60.0,
              );
              final double itemSize = slotSize;
              final double gridGap = (GameState.baseGridGap * uiScale).clamp(
                4.0,
                10.0,
              );
                              ...
                              AnimatedPositioned(
                                ...
                                child: Opacity(
                                  ...
                                  child: _NarrativeTargetGemPulse(
                                    active: gameState
                                        .narrativeGuideGemShouldPulse(item.id),
                                    child: FloatingGem(
                                      ...
                                      child: _GemTapJuice(
                                        ...
                                        child: _ItemFx(
                                          ...
                                          child: _NeonHalo(
                                            ...
                                            alert: gameState.alertIds.contains(
                                              item.id,
                                            ),
                                            lowGlow:
                                                gameState
