...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get settingsPrivacyPolicySubtitle => 'Ouvrir dans le navigateur';

  @override
  String get settingsPrivacyPolicyLaunchFail => 'Impossible d’ouvrir le lien.';
  ...
  String gameOverCareerRecordHint(int high) {
    return 'Record carrière (enregistré) : $high';
  }
  ...
  String welcomeGiftBannerLux(int lux) {
    return 'DOTATION VELOUR : +$lux LUX';
  }

  @override
  String get oracleNamingDialogTitle => 'L\'EXCELLENCE VOUS DÉFINIT';

  @override
  String get oracleNamingDialogBody =>
      'Choisissez le nom sous lequel l\'Oracle doit vous connaître. Il sera enregistré en minuscules pour éviter les doublons.';

  @override
  String get oracleNamingValidationRequired => 'Nom requis';

  @override
  String get oracleNamingValidationTooLong => '15 caractères max';

  @override
  String get oracleNamingValidationInvalidChars =>
      'Lettres, chiffres et _ uniquement (15 max)';
  ...
  @override
  String get oracleNamingSealButton => 'SCELLER MON NOM';
  ...
  @override
  String get gameHudPerfectHeatLabel => 'FEU';

  @override
  String get gameHudPerfectHeatNearFloater => ' PRESQUE';

  @override
  String get gameHudPerfectHeatRebound => 'REBOND';
  ...
  @override
  String get gameHudPerfectHeatSurgeTitle => 'FEU MONTANT !';

  @override
  String gameHudPerfectHeatSurgeSubtitle(int heatTier) {
    return 'Palier $heatTier';
  }
  ...
  String a11yRackSlotEmpty(int slot, int max) {
    return 'Emplacement $slot sur $max du rack, vide.';
  }

  @override
  String a11yRackSlotOccupied(int slot, int max) {
    return 'Emplacement $slot sur $max du rack, occupé.';
  }

  @override
  String get a11yRackSlotImminentHint => 'Paire adjacente presque complète.';
}
