...
## 描述（4000 字以内）
**你看见盘面，时间不会讨价还价。** Velour 是一款**偏硬核的霓虹解谜**：每一局 **run** 都是**逻辑与胆量的考试**——形状消除、颜色消除，以及一发入魂的 **Perfect（三颗完全相同）**——分数飙升、**Heat** 叠起，换来更高 **LUX** 与关键时刻的补时。适合喜欢**高压下仍要算清楚**的人。
...
## 完整说明（4000 字以内）
**盘面是考题，时间是裁判。** Velour 把 **跑分式 run** 做成**策略 + 解谜**：三连、**Perfect**、**LUX**、**Heat**——给喜欢**高压下做决策**的人。
