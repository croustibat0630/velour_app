...
abstract final class NarrativeTutorialBoardSpecs {
  static const List<({int typeId, int colorId})> step1Gems =
  ...
  static const List<({int typeId, int colorId})> step2Gems =
      <({int typeId, int colorId})>[
        (typeId: 1, colorId: 2),
        (typeId: 7, colorId: 2),
        (typeId: 4, colorId: 2),
...
abstract final class TrinityTutorialBoardSpecs {
  ...
  static List<({int typeId, int colorId})>? gemsFor(
    TrinityTutorialPhase phase,
  ) {
    switch (phase) {
