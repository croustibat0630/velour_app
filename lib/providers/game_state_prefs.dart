...
abstract final class GameStatePrefs {
  ...
  static const String lastDailyLuxClaimUtcDay =
      'velour_last_daily_lux_claim_utc_day';
  ...
  static const String pendingLuxByMotifJson =
      'velour_pending_lux_by_motif_json';
