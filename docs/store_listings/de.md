...
*Même principe qu’en français : page de localisation de la version iOS, champ What’s New in This Version — obligatoire pour chaque langue. Texte ci‑dessous en allemand pour les joueurs ; à adapter à chaque release (réf. dépôt : 1.2.2+20).*

• Optimiertes Edge-to-Edge auf Android 15+ (Systemleisten und Einzüge).
• Zuverlässigere Spieleffekte auf Android; Fehlerbehebungen und Stabilität.
...
• Android 15 Edge-to-Edge; zuverlässige SFX; Fixes (v. 1.2.2).
